...
class OidcClient {
    ...
    async refresh(token) {
        const newToken = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kubernetes$2f$client$2d$node$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["refreshTokenGrant"](this.config, token);
        return {
...
class OpenIDConnectAuth {
    ...
    async getClient(user) {
        const configuration = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kubernetes$2f$client$2d$node$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["discovery"](user.authProvider.config['idp-issuer-url'], user.authProvider.config['client-id']);
